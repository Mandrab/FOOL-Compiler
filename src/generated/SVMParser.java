...
public class SVMParser extends Parser {
	...
	public static class AssemblyContext extends ParserRuleContext {
		...
		public List<TerminalNode> LOADTM() { return getTokens(SVMParser.LOADTM); }
		public TerminalNode LOADTM(int i) {
			return getToken(SVMParser.LOADTM, i);
		}
		public List<TerminalNode> STORETM() { return getTokens(SVMParser.STORETM); }
		public TerminalNode STORETM(int i) {
			return getToken(SVMParser.STORETM, i);
		}
